...
class DataPreparation:
    ...
    def _create_preprocessor(self) -> ColumnTransformer:
        """
        Create a preprocessor pipeline for transforming numrical, nominal and ordinal features.
        ...
        passthrough_transformer = Pipeline(
            steps=[
                (
                    "passthrough",
                    StandardScaler(
                        categories=[self.config["Risk_of_Heart_Disease_catagories"]],
...
@staticmethod
def _convert_BMI(BMI: int) -> float:
    """
    Converts a BMI value into a float.

    Args:
    -----
    BMI (int): The BMI value to convert to float positive and negative values.
...
@staticmethod
def _convert_Cholesterol_Levels(Cholesterol_Levels: int) -> float:
    """
    Converts a Cholesterol_Levels value into a float.

    Args:
    -----
    Cholesterol_Levels (int): The Cholesterol_Levels int value to convert to float values.
...
class ColumnTransformer(
    ...
    *,
    reminder: BaseEstimator | Literal['drop', 'passthrough'] = "drop",
